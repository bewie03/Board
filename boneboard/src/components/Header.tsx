...
import { FaUserCircle, FaBone, FaWallet, FaRegBookmark, FaShieldAlt, FaBriefcase, FaFolderOpen, FaCog } from 'react-icons/fa';
                    ...
                    <div className="p-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <button
                          ...
                          className="w-full text-left px-4 py-3 text-sm font-medium text-gray-700 hover:bg-blue-50 hover:text-blue-700 rounded-lg transition-colors duration-200 flex items-center"
                        >
                          <FaRegBookmark className="w-5 h-5 mr-3 text-blue-600" />
                          Saved Jobs
                        </button>
                        ...
                        <button
                          ...
                          className="w-full text-left px-4 py-3 text-sm font-medium text-gray-700 hover:bg-blue-50 hover:text-blue-700 rounded-lg transition-colors duration-200 flex items-center"
                        >
                          <FaFolderOpen className="w-5 h-5 mr-3 text-blue-600" />
                          My Projects
                        </button>
