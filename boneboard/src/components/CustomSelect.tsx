...
const CustomSelect: React.FC<CustomSelectProps> = ({
  ...
  return (
    <div className="relative" ref={selectRef}>
      <div
        id={id}
        className={`w-full px-3 py-2 pr-8 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white cursor-pointer flex items-center justify-between transition-all duration-200 hover:border-gray-400 hover:shadow-md text-sm min-h-[2.5rem] ${
