                ...
                filteredJobs.map((job, index) => (
                  ...
                  >
                    ...
                    {job.isProjectVerified && (
                      <div className={`absolute top-4 z-10 ${job.featured ? 'left-20' : 'left-4'}`}>
                        <div 
                          className="w-6 h-6 rounded-full bg-blue-500 text-white flex items-center justify-center flex-shrink-0"
