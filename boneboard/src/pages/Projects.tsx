...
import { FaGlobe, FaLink, FaDiscord, FaExternalLinkAlt, FaTimes, FaMapMarkerAlt, FaClock, FaCoins, FaDollarSign, FaBuilding, FaSearch, FaFlag, FaInfoCircle } from 'react-icons/fa';
